...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://loarien.com/api/v1/pos';
  }
  ...
  Future<AddRfidResponse> addRfidToCart(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addRFidRequestModel.toJson());
    final _options = _setStreamType<AddRfidResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/cart/add-rfid',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddRfidResponse _value;
    try {
      _value = AddRfidResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<CartResponseModel> addCustomItem(
    AddCustomItemRequest addCustomItemRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addCustomItemRequest.toJson());
    final _options = _setStreamType<CartResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<SystemSettingsResponse> getSystemSettings() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SystemSettingsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/system/settings',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SystemSettingsResponse _value;
    try {
      _value = SystemSettingsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<ApplyDiscountResponse> applyDiscount(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(applyDiscountRequest.toJson());
    final _options = _setStreamType<ApplyDiscountResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/cart/discount',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApplyDiscountResponse _value;
    try {
      _value = ApplyDiscountResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<CartResponseModel> deleteCartItem(String path) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
